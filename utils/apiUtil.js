 ...
 * 激活接口
 */
exports.activeDevice = (userinfo) => {
    return new Promise(function(resolve, reject){
        let client = getSignature(userinfo);
        let options = {
 ...
 * 重新激活接口
 */
exports.reActiveDevice = (userinfo) => {
 ...
 * 查询设备状态
 */
exports.getOnline = function(deviceinfo) {
    return new Promise(function(resolve, reject){
        let client = getSignature(deviceinfo);
        let options = {
            url: yaokan_config.url,
            method: 'POST',
            timeout: 5000,
            ...
            form: {
                c: 'ds',
                app_id: config.yaokan_config.app_id,
                f: deviceinfo.f
            }
        };
        request(options, function (err, res, body) {
